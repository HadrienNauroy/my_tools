...
import my_tools.monitoring.message as ms
import time as tm
...
class Monitor_Bot:
    ...
    def __init__(self, config):
        ...
        self.last_message = ms.retreive_messages(self.browser)
        print(self.last_message)
        self.trading_duration = None
        self.stand_by_duration = None
        self.browser = ms.connect(config)

    def _update_state(self):
        messages = ms.retreive_messages(self.browser)
        ...
        for message in messages:
            ...
            try:
                ...
                ms.send_message(self.browser, e.message)
